...
/**
 * RecordSet list Flowlet.
 *
 * @author Tommi S.E. Laukkanen
 */
public final class RecordSetsFlowlet extends AbstractFlowlet {

    /** Serial version UID. */
    private static final long serialVersionUID = 1L;
    /** The container. */
    private EntityContainer<RecordSet> container;
    /** The grid. */
    private Grid grid;
    ...
    public void initialize() {
        final List<FieldDescriptor> fieldDescriptors = CeciFields.getFieldDescriptors(RecordSet.class);
