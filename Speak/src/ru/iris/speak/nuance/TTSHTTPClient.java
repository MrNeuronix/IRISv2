...
public class TTSHTTPClient {
     ...
     */
    public HttpPost getHeader(URI uri) throws UnsupportedEncodingException
    {
     ...
     */
    public void processResponse(HttpResponse response) throws IllegalStateException, IOException
    {
