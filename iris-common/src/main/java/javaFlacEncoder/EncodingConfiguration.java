...
public class EncodingConfiguration implements Cloneable {
     ...
     * {@link javaFlacEncoder.EncodingConfiguration.ChannelConfig ChannelConfig} for more info on choices.
     *
     ...
     * is compressed. See documentation for {@link javaFlacEncoder.EncodingConfiguration.SubframeType SubframeType} for
    ...
    public int getMaxLPCOrder() {
        return maximumLPCOrder;
    }

    /**
     * Set the minimum LPC order. If order given is out of the valid range(as
     * defined by {@link javaFlacEncoder.EncodingConfiguration#MAX_LPC_ORDER MAX_LPC_ORDER} and
     * {@link javaFlacEncoder.EncodingConfiguration#MIN_LPC_ORDER MIN_LPC_ORDER}), it will be
     ...
     * (as defined by {@link javaFlacEncoder.EncodingConfiguration#MAX_LPC_ORDER MAX_LPC_ORDER}
     * and {@link javaFlacEncoder.EncodingConfiguration#MIN_LPC_ORDER MIN_LPC_ORDER}), it will be
     * set to the closest valid value instead.
     *
