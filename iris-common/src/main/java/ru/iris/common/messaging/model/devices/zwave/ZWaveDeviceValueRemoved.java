 ...
 * License: GPL v3
 */
public class ZWaveDeviceValueRemoved {
    /**
     * Zwave device
     */
    @Expose
    ...
    public ZWaveDeviceValueRemoved set(ZWaveDevice device, String label, String value) {
        this.device = device;
        this.label = label;
        this.value = value;
        return this;
     ...
     */
    public ZWaveDeviceValueRemoved() {
    }
    ...
    public String toString() {
        return "ZWaveDeviceValueRemoved{" +
