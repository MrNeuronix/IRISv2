 ...
 */
public class GoogleSynthesiser implements Synthesiser {
     ...
     */
    public GoogleSynthesiser(String API_KEY) {
    ...
    public InputStream getMP3Data(String synthText) throws IOException {
        ...
        if (languageCode == null || languageCode.equals("") || languageCode.equalsIgnoreCase("auto")) {
            languageCode = "ru-ru";//Reverts to Default Language if it can't detect it.
        }
